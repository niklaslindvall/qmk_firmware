...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|-------+-------+-------+-------+-------+-------+-------.    ,-------|-------+-------+-------+-------+-------+-------|
     KC_LCTL, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,KC_BSPC,     KC_DEL , KC_N  , KC_M  ,KC_COMM, KC_DOT,KC_SLSH,KC_BSLS,
  //`-------+-------+-------+--+----+-------+-------+-------/    \-------+-------+-------+-------+-------+-------+-------'
                                   KC_LGUI ,KC_RASE, KC_SPC,      KC_ENTER,KC_LOWR,KC_LALT
  //                              `-------+-------+-------'        `-------+-------+-------'
),
  ...
  //|-------+-------+-------+-------+-------+-------|                    |-------+-------+-------+-------+-------+-------|
     SE_GRV ,_______, KC_UP ,_______,KC_PGUP,KC_HOME,                     _______,KC_BTN1,KC_MS_U,KC_BTN2,KC_VOLD,KC_VOLU,
  //|-------+-------+-------+-------+-------+-------|                    |-------+-------+-------+-------+-------+-------|
     _______,KC_LEFT,KC_DOWN,KC_RGHT,KC_PGDN,KC_END ,                     _______,KC_MS_L,KC_MS_D,KC_MS_R,KC_MPRV,KC_MNXT,
  //|-------+-------+-------+-------+-------+-------+-------.    ,-------|-------+-------+-------+-------+-------+-------|
